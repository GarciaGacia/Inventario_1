...
<?php
 /* convierte un mes numerico [1-12] en una cadena,
 * en el idioma actual */
...
<?php
  ...
  /* predeterminado a la fecha actual no queremos el calendario lunar */
  $year  = date('Y');
  $month = date('m');
...
<!-- DataTable ((solo para mas de 10 elementos)-->
<?php if (count_id() > 10): ?>
