...
<?php
  ...
  /* Obtener registro de venta, de id de venta */
  ...
  /* Obtener el registro de producto, desde el identificador de producto*/
  ...
  /* Obtener category_name y media_name */
...
<?php
  ...
  if( isset($_POST['update_sale']) ) {
    ...
    if( validate_fields($req_fields) ){
      ...
      $extra_qty = $s_qty - $sale['qty'];     /* <-- nota esto !!! */
        ...
        <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']?>" class="clearfix">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <span class="form-control rounded">
                  <!-- El nombre del producto NO es editable ====== -->
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-3"><!-- separador de columnas --></div>
              <div class="col-md-3">
