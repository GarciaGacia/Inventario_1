...
<?php
  /* Esta es la primera consulta (usando GET)
  * Permite inicializar el formulario de usuario con el actual
  * datos del ID de grupo dado
  *
  * NOTA: agregué la condición isset () para verificar la identificación
  * está presente en la solicitud.
  */
  if ( isset( $_GET['id'] ) ) {
