<?php
  ...
  // 
  // Checkin Que nivel de usuario tiene permiso para ver esta pagina (esto es importante) 
  page_require_level(2);
  $products = join_product_table();
?>

<?php
  /* Procesamiento de Userfom */
  if (isset($_POST['method'])) {
    if ($_POST['method'] == "update") {
      if (!isset($_POST['data'])) {
        /* sin redireccionamiento, solo salga, ya que se volvera a cargar a traves de JavaScript */
        exit;
      }
        ...
        <table class="table table-hover" id="tbl_products">
          <thead>
            <tr>
              ...
              <!--<th class="text-center" style="width: 10%;"> Agregado :3 </th>-->
...
<!-- Este es el script jQuery para el fondo de esta pagina.-->
