...
<?php
  ...
  /* tenemos que recuperar ventas aqui*/
      ...
      <div class="panel-heading clearfix">
        <strong>
          ...
          <?php
            ...
            $monday = date('Y-m-d', strtotime('-'.($day_of_week-1).' days', $target));
            $sunday = date('Y-m-d', strtotime('+'.(7-$day_of_week).' days', $target));
          ?>
          <span>
...
<!-- ThiEste es el fondo de jQuery para esta pagina -->
